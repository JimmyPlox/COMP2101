...
function userQuit()
{
  echo "Signal quit recieved, you found the secret way to quit!"
}

function userInterrupt()
{
  echo "You are not allowed to interrupt the count, resetting now!"
...
trap userInterrupt SIGINT
trap userQuit SIGQUIT
